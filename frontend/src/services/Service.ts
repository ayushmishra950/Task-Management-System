...
export const markAsReadNotifications = async (userId, companyId) => {
  const res = await axios.put(
    `${import.meta.env.VITE_API_URL}/api/auth/notification/read`, { userId, companyId }
  );
...
export const AbsentAddAttendancebyday = async (obj) => {
  const res = await axios.patch(
    `${import.meta.env.VITE_API_URL}/api/attendance/absent/attendance`, obj)
...
export const loginSuperAdmin = async (email, password) => {
  const res = await axios.post(
    `${import.meta.env.VITE_API_URL}/api/superAdmin/auth/login`, { email: email, password: password }
  );
...
export const deleteTaskManager = async (id, companyId, employeeId, departmentId) => {
  const res = await axios.delete(
    `${import.meta.env.VITE_API_URL}/api/task/manager/delete`, { params: { userId: id, companyId: companyId, employeeId: employeeId, departmentId } }
  );
...
export const getCompanysById = async (id) => {
  const res = await axios.get(
    `${import.meta.env.VITE_API_URL}/api/company/detail/company`, { params: { companyId: id } }
  );
...
export const UpdateLeave = async (obj) => {
  const res = await axios.patch(
    `${import.meta.env.VITE_API_URL}/api/company/update/Leave`, obj
  );
...
export const getleaveDashboard = async (obj) => {
  const res = await axios.get(
    `${import.meta.env.VITE_API_URL}/api/leave-requests/leave/dashboard`, { params: obj }
  );
...
export const loginEmployee = async (email, password) => {
  const res = await axios.post(
    `${import.meta.env.VITE_API_URL}/api/employees/login`, { email: email, password: password }
  );
...
export const addMessage = async (obj: any) => {
  const res = await axios.post(
    `${import.meta.env.VITE_API_URL}/api/message/add`,
    obj,
    { headers: { "Content-Type": "multipart/form-data" } }
  );
...
export const getMessage = async (leadId:string) => {
  const res = await axios.get(
    `${import.meta.env.VITE_API_URL}/api/message/get`, {params:{leadId:leadId}}
  );
